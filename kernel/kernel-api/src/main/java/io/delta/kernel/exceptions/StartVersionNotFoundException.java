...
/**
 * Exception thrown when Kernel cannot find a log file for the requested start version. This can
 * happen when the requested start version has been cleaned up due to log retention policies, or
 * when the version does not exist in the table.
 *
 * @since 4.1.0
 */
@Evolving
public class StartVersionNotFoundException extends KernelException {
  ...
  /** @return the earliest available version in the table, or empty if no versions are available */
